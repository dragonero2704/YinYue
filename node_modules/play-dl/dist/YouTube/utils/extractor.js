...
exports.getContinuationToken = exports.getPlaylistVideos = exports.playlist_info = exports.video_info = exports.video_basic_info = exports.validate_playlist = exports.validate = void 0;
...
function validate_playlist(url) {
...
exports.validate_playlist = validate_playlist;
async function video_basic_info(url, cookie) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p;
    if (!url.match(video_pattern))
        throw new Error('This is not a YouTube URL');
    let video_id;
    ...
    let body = await request_1.url_get(new_url, {
    ...
    let badge = ((_d = (_c = (_b = (_a = initial_response.contents.twoColumnWatchNextResults.results.results.contents[1]) === null || _a === void 0 ? void 0 : _a.videoSecondaryInfoRenderer) === null || _b === void 0 ? void 0 : _b.owner) === null || _c === void 0 ? void 0 : _c.videoOwnerRenderer) === null || _d === void 0 ? void 0 : _d.badges) && ((_h = (_g = (_f = (_e = initial_response.contents.twoColumnWatchNextResults.results.results.contents[1]) === null || _e === void 0 ? void 0 : _e.videoSecondaryInfoRenderer) === null || _f === void 0 ? void 0 : _f.owner) === null || _g === void 0 ? void 0 : _g.videoOwnerRenderer) === null || _h === void 0 ? void 0 : _h.badges[0]);
    ...
    if (player_response.playabilityStatus.status === 'LOGIN_REQUIRED')
    ...
    let video_details = {
        ...
        channel: {
            ...
            verified: Boolean((_k = (_j = badge === null || badge === void 0 ? void 0 : badge.metadataBadgeRenderer) === null || _j === void 0 ? void 0 : _j.style) === null || _k === void 0 ? void 0 : _k.toLowerCase().includes('verified'))
        },
        views: vid.viewCount,
        tags: vid.keywords,
    ...
    let LiveStreamData = {
        ...
        dashManifestUrl: ((_l = player_response.streamingData) === null || _l === void 0 ? void 0 : _l.dashManifestUrl) ? (_m = player_response.streamingData) === null || _m === void 0 ? void 0 : _m.dashManifestUrl : null,
        hlsManifestUrl: ((_o = player_response.streamingData) === null || _o === void 0 ? void 0 : _o.hlsManifestUrl) ? (_p = player_response.streamingData) === null || _p === void 0 ? void 0 : _p.hlsManifestUrl : null
    };
    return {
        LiveStreamData,
        html5player,
